...
const std::unordered_set<std::string> stop_words = {
		...
		"latterly", "lb", "lc", "le", "least", "les", "less", "lest", "let", "lets", "let's", "lf", "liked",
		"likely", "line", "lj", "ll", "ll", "ln", "lo", "look", "looking", "looks", "los", "lr", "ls", "lt",
		...
		"why's", "wi", "widely", "will", "willing", "wish", "with", "within", "without", "wo", "won", "wont",
		"won't", "words", "would", "wouldn", "wouldnt", "wouldn't", "www", "x", "x1", "x2", "x3", "xf", "xi",
		...
		// It's necessary to remove those to pass tests
		//, "like",  "little",  "wonder",  "world",
};
